...
#ifndef _POSH_COLL_GASPI_H_
#define _POSH_COLL_GASPI_H_
...
class Collectives_GASPI_t : public Collectives_t {
 ...
 private:
    ...
    //  std::unordered_map< unsigned long, GASPI_Op> operations;
...
#endif //define _POSH_COLL_GASPI_H_
